...
Итог противоинтуитивен: **больше NFE — хуже** (0.13 при 40 → 0.19 при 400):
Ланжевен-шум корректора за длинной цепочкой накапливает ошибку грубой
ε-модели в зерно. Мягкие читаемые цифры — в районе 100 NFE; 40 — призраки;
400 — плотнее и шумнее. Тяжёлый корректор (corr=10 у ранних пресетов) —
только хуже. Мораль: непрерывные SDE/ODE-солверы на этой модели дают чистый
