...
40–200 — пятна без цифр (редкая сетка уровней = грубые прыжки Δσ), 400 —
мягкие намёки, **600 — оптимум**, 800–1000 — зерно растёт. Две важные
оговорки из экспериментов вокруг:
